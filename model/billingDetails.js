...
const billingDetailsSchema = mongoose.Schema(
  {
    ...
    billingDetails: [{
      billingItems: { type: mongoose.Schema.Types.ObjectId, ref: 'billingItems', required: true },
    ...
    category: { type: mongoose.Schema.Types.ObjectId, ref: 'billingCategories', required: true }, // Reference to billing category
    ...
    customerEmail: { type: String, required: true }, // Email of the customer being billed
    ...
    nextBillingDate: { type: Date, required: true }, // Next billing date for recurring payments
    createdBy: { type: String, required: true }, // User who created the billing record
    updatedBy: { type: String, required: true }, // User who last updated the billing record
